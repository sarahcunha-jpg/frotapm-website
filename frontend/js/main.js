...
document.addEventListener('DOMContentLoaded', function() {
    ...
    app.innerHTML = `
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item"><a class="nav-link" href="#" onclick="switchTab('dashboard')">Dashboard</a></li>
                            <li class="nav-item"><a class="nav-link" href="#" onclick="switchTab('viaturas')">Viaturas</a></li>
                            <li class="nav-item"><a class="nav-link" href="#" onclick="switchTab('os')">Ordens de Serviço</a></li>
                            <li class="nav-item"><a class="nav-link" href="#" onclick="switchTab('manutencao')">Manutenção</a></li>
                            <li class="nav-item"><a class="nav-link" href="#" onclick="switchTab('rastreamento')">Rastreamento</a></li>
                            <li class="nav-item"><a class="nav-link" href="#" onclick="switchTab('relatorios')">Relatórios</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="tab-dashboard" data-bs-toggle="tab" data-bs-target="#content-dashboard" type="button" onclick="switchTab('dashboard')">
                            <i class="bi bi-speedometer2"></i> Dashboard
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-viaturas" data-bs-toggle="tab" data-bs-target="#content-viaturas" type="button" onclick="switchTab('viaturas')">
                            <i class="bi bi-car-front"></i> Viaturas
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-os" data-bs-toggle="tab" data-bs-target="#content-os" type="button" onclick="switchTab('os')">
                            <i class="bi bi-file-text"></i> Ordens de Serviço
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-manutencao" data-bs-toggle="tab" data-bs-target="#content-manutencao" type="button" onclick="switchTab('manutencao')">
                            <i class="bi bi-tools"></i> Manutenção
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-rastreamento" data-bs-toggle="tab" data-bs-target="#content-rastreamento" type="button" onclick="switchTab('rastreamento')">
                            <i class="bi bi-map"></i> Rastreamento
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="tab-relatorios" data-bs-toggle="tab" data-bs-target="#content-relatorios" type="button" onclick="switchTab('relatorios')">
        ...
        <div class="tab-content">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card shadow-sm h-100">
                                <div class="card-body text-center">
                                    ...
                                    <a href="#" onclick="switchTab('rastreamento')" class="btn btn-primary btn-sm">Acessar Rastreamento</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card shadow-sm h-100">
                                <div class="card-body text-center">
                                    ...
                                    <a href="#" onclick="switchTab('relatorios')" class="btn btn-success btn-sm">Ver Relatórios</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- VIATURAS TAB -->
            <div class="tab-pane fade" id="content-viaturas">
                <div class="container-fluid py-4">
            ...
            <div class="tab-pane fade" id="content-os">
                <div class="container-fluid py-4">
            ...
            <!-- MANUTENÇÃO TAB -->
            <div class="tab-pane fade" id="content-manutencao">
                <div class="container-fluid py-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-3">
                            <div class="card bg-info text-white">
                                <div class="card-body text-center">
                                    <h3>8</h3>
                                    <p class="mb-0">Manutenções Preventivas Agendadas</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-warning text-white">
                                <div class="card-body text-center">
                                    <h3>3</h3>
                                    <p class="mb-0">Manutenções Corretivas Pendentes</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-success text-white">
                                <div class="card-body text-center">
                                    <h3>25</h3>
                                    <p class="mb-0">Manutenções Concluídas (Mês)</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-danger text-white">
                                <div class="card-body text-center">
                                    <h3>2</h3>
                                    <p class="mb-0">Manutenções em Atraso</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- RASTREAMENTO TAB -->
            <div class="tab-pane fade" id="content-rastreamento">
                <div class="container-fluid py-4">
            ...
            <!-- RELATÓRIOS TAB -->
            <div class="tab-pane fade" id="content-relatorios">
                <div class="container-fluid py-4">
...
function switchTab(tabName) {
    ...
    const contentDivs = document.querySelectorAll('.tab-pane');
    ...
    // Reinitialize map if rastreamento tab is opened
    if (tabName === 'rastreamento') {
        setTimeout(() => {
            if (window.map) {
    ...
    script.onload = function() {
        ...
        vehicles.forEach(vehicle => {
            ...
            L.circleMarker([vehicle.lat, vehicle.lng], {
                ...
                opacity: 1,
                fillOpacity: 0.8
            }).bindPopup(`<strong>${vehicle.name}</strong><br>Status: ${vehicle.status}`).addTo(map);
        });
